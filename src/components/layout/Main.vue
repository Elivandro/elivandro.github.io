        ...
        <section class="h-screen" id="home">
            <div class="flex items-center pt-48 mx-4 justify-evenly">
                <div class="flex flex-col items-center">
                    ...
                    <NavLink link="#about" title="Saber mais" class="inline-flex items-center justify-center px-4 py-2 text-base font-medium text-white transition-colors rounded-lg select-none disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-dark-eval-2 hover:bg-slate-600 focus:ring-slate-500 bg-slate-800" />

                    <ul class="flex items-end justify-center space-x-4 space-y-16" id="socialmedia-icons">
                        <li>
                            <a href="https://www.linkedin.com/in/elivandro-silva-55b057227/" target="_blank" class="transition duration-150 ease-in-out rounded-full text-slate-800">
                                <!-- LinkedIn svg -->
                        ...
                        <li>
                            <a href="https://github.com/Elivandro" target="_blank" class="transition duration-150 ease-in-out rounded-full text-slate-800">
                                <!-- Github svg -->
                        ...
                        <li>
                            <a href="https://api.whatsapp.com/send?phone=5569999076818" target="_blank" class="transition duration-150 ease-in-out rounded-full text-slate-800">
                                <!-- Whatsapp svg -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" viewBox="0 0 48 48">
            ...
            <div class="flex flex-col items-center flex-auto pt-8">
                ...
                <div class="max-w-6xl text-lg">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        ...
                        <!-- Card HTML -->
                        <div class="flex flex-col justify-between overflow-hidden transition-transform duration-300 transform scale-95 bg-white border rounded-lg shadow-md hover:scale-100">
                            <div class="p-4">
                    ...
                    <div class="mt-4">
                        <figure class="flex flex-wrap justify-center object-cover object-center gap-4 prose-img:cursor-pointer">
                            <a href="https://www.gerenciemei.com.br/" target="_blank" class="duration-300 transform scale-95 opacity-75 transition-ease-in-out hover:opacity-100 hover:scale-100">
                                <img src="../../assets/images/projects/case1.png" class="shadow rounded-xl sm:w-[320px]" alt="imagem do projeto 1" title="Gerencie MEI site para gestão de empresas de pequenos empreendedores" />
                            </a>
                            <a href="https://elivandro.github.io/learn-proj/CMLife/" target="_blank" class="duration-300 transform scale-95 opacity-75 transition-ease-in-out hover:opacity-100 hover:scale-100">
                                <img src="../../assets/images/projects/case2.jpg" class="shadow rounded-xl sm:w-[320px]" alt="imagem do projeto 2" title="Clínica médica Life, exemplo de um site de clínica médica" />
                            </a>
                            <a href="https://elivandro.github.io/learn-proj/PousadaSecreta/" target="_blank" class="duration-300 transform scale-95 opacity-75 transition-ease-in-out hover:opacity-100 hover:scale-100">
                                <img src="../../assets/images/projects/case3.jpg" class="shadow rounded-xl sm:w-[320px]" alt="imagem do projeto 3" title="Pousada Secreta, exemplo do site de uma pousada com resort" />
                            </a>
                            <a href="https://elivandro.github.io/learn-proj/projetoEstagio/" target="_blank" class="duration-300 transform scale-95 opacity-75 transition-ease-in-out hover:opacity-100 hover:scale-100">
                                <img src="../../assets/images/projects/case4.jpg" class="shadow rounded-xl sm:w-[320px]" alt="imagem do projeto 3" title="Busca de pacotes de viagens e hospedagem, exemplo de site" />
                            </a>
                            <a href="https://elivandro.github.io/learn-proj/AgenciaViagens/" target="_blank" class="duration-300 transform scale-95 opacity-75 transition-ease-in-out hover:opacity-100 hover:scale-100">
                                <img src="../../assets/images/projects/case5.png" class="shadow rounded-xl sm:w-[320px]" alt="imagem do projeto 3" title="Busca de pacotes de viagens e hospedagem, exemplo de site" />
                            </a>
                        </figure>
                    </div>
                </div>
...
<script>
    ...
    export default {
    name: "Main",
    components: { NavLink, PrimaryButton }
}
</script>