<template>
    <header
        class="fixed z-50 flex flex-wrap w-full py-4 text-sm bg-gray-200 shadow-md dark:text-gray-200 text-grat-800 dark:bg-gray-900 sm:justify-start sm:flex-nowrap">
        <nav class="w-full max-w-6xl px-4 mx-auto sm:flex sm:items-center sm:justify-between" aria-label="Global">
            <div class="flex items-center justify-between">
                <a class="cursor-pointer inline-flex items-center text-xl font-semibold gap-x-2" href="/">
                ...
                <div class="sm:hidden">
                    <button type="button" @click="handleMenu()"
                        class="inline-flex items-center justify-center gap-2 p-2 text-sm font-medium text-gray-700 align-middle transition-all bg-white rounded-md shadow-sm dark:text-gray-900 hs-collapse-toggle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600"
            ...
            <div id="nav" class="hidden overflow-hidden transition-all duration-300 hs-collapse sm:block">
                <ul id="ul"
                    class="flex flex-col gap-5 uppercase sm:flex-row sm:items-center sm:justify-center sm:mt-0 sm:pl-5">
                    <li>
